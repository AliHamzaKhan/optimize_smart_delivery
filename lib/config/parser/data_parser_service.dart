...
import 'input_mask_service.dart';
...
class DataParserService {
  ...
  getFirstStringChar(token) {
    return token[0].toString().toUpperCase();
  }
}
...
class InputValidation {
  ...
  String? validateName(String value, {label = "Name"}){
    if (value.length == 0) {
  ...
  String? validateConfirmPassword(String? txt, String? otherTxt,
    ...
    appDebugPrint('txt $txt');
    appDebugPrint('otherTxt $otherTxt');
    if (txt == null || txt.isEmpty) {
