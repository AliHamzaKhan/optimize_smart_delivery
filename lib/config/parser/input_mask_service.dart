...
class InputMaskService implements TextInputFormatter {
  late final MaskAutoCompletionType type;
  ...
  String maskText(String text) {
    return InputMaskService(mask: _mask, filter: _maskFilter, initialText: text)
        .getMaskedText();
  }
